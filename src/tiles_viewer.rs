...
fn main() {
    ...
    let video_subsystme = sdl_context.video().unwrap();
    let window = video_subsystme.window("tile viewer", (256.0 * 3.0) as u32, (240.0 * 3.0) as u32).position_centered().build().unwrap();
