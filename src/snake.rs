...
fn create_fake_rom(file_name: String) {
    ...
    let header = vec![0x4E, 0x45, 0x53, 0x1A, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];

    let pre = [0; 0x600];

    let code = vec![0x20, 0x06, 0x06, 0x20, 0x38, 0x06, 0x20, 0x0d, 0x06, 0x20, 0x2a, 0x06, 0x60, 0xa9, 0x02,
...
fn main() {
    create_fake_rom(String::from("snake.nes"));
}